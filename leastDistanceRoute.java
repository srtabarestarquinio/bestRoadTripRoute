...
public class leastDistanceRoute{
	...
	public String [] route(String starting_city, String ending_city, String [] attractions){
		...
		int numLocations = attractions.length + 2;
		String [] locationsList = new String [numLocations];
		...
		locationsList[0] = starting_city;
		locationsList[numLocations-1] = ending_city;
		...
		String [] minRoute = Dijkstra(locationsList);
	...
	public String[] attractionsLocations( String[] attractions, String[] locationsList ){
  		String csvSplit = ",";
		String line = "";
  		...
  		try{
			...
			while ((line = attractionsFile.readLine()) != null){
				...
				for (int i=0; i<attractions.length; i++){
					if(attractions[i].equals(attraction[0])){
						locationsList[i+1]=attraction[1];}
				}
			}
	...
	public String[] Dijkstra(String[] locationsList){
	  	String [] routeDijkstra = new String[locationsList.length];
		...
		int cost = calcDistance(locationsList[0], locationsList[1]);
  ...
  public static void main(String[] args){
	...
	int numAttractions = Integer.valueOf(input.nextLine());
  	...
  	List<String> attractions = minRoute.List();

  	String [] attractions = new String [numAttractions];
  	...
  	String [] bestRoute = minRoute.route(starting_city, ending_city, attractions);
